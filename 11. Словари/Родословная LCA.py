...
#Мое решение
#Не смог сделать - подсмотрел решение в интернете. Идею, такую как используется в варианте от разработчиков продумывал и пробовал релизовать
#но не смог сообразить как сравнить одинаковые сеты и сделать выборку.
